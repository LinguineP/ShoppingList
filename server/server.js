...
app.delete('/tasks/:id', async (req, res) => {
  ...
  use like delete just with one more param
  
  */

  app.put('/tasks/:id/:doneStatus', async (req, res) => {
   

   result= await Task.updateMany({ taskId: req.params.id }, { done : req.params.doneStatus });
